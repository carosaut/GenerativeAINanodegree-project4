...
### I had initially set up the prompt to generate one listing at a time, but this way works far better and reduced repetition. ###

property_generator_prompt = """Your task is to generate 10 fake real estate listing to test a home matching application. 

Strictly adhere to the following rules:  
- The listings should be in a list of python dictionaries in the style and format of the examples shown below. 
- There should be no duplicate listings in the list. 
- Only return the list of dictionaries and do not give the list a name, introduction, or any additional commentary.
